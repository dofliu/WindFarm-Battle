...
## 🆕 v2 技師版待補插畫清單（2026-07-13）

v2 卡池（cards-v2.json，45 張）中以下 26 張是新卡、**尚無專屬照片**，
目前在 `cards-v2.json` 以 `image` 欄位暫借語意相近的既有 jpg（映射見該檔）。
Dof 生成新圖後放進 `public/cards/<ID>.jpg` 並移除該卡的 `image` 欄位即可自動切換。

| 類 | 卡 | 暫借圖 |
|---|---|---|
| 技師 | T10 變流器工程師 | T04.jpg |
| 技師 | T11 複材葉片專家 | T02.jpg |
| 技師 | T12 風場經理 | T07.jpg |
| 技師 | T13 預測維護專家 | T05.jpg |
| 技師 | T14 運維總監 | T09.jpg |
| 技師 | T15 總工程師 | T06.jpg |
| 工具 | TL01–TL08 | FN01/W01/W03/FN02/FN05/FN03/T08/FN07 |
| 道具 | IT01–IT09 | FN09/W04/FN04/UP02/UP01/UP03/UP04/FN08/C03 |
| 合約 | CT01–CT03 | C01/C02/C04 |
| 道具(v2.1) | IT10 能量飲料 | FN06.jpg |
| 道具(v2.1) | IT11 輪休排班 | M02.jpg |
| 道具(v2.1) | IT12 團隊補給站 | M04.jpg |
| 道具(v2.1) | IT13 安全講習 | M06.jpg |
| 工具(v2.1) | TL09 外骨骼支架 | M09.jpg |
| 工具(v2.1) | TL10 智慧監測手環 | M10.jpg |

技師照片 prompt 建議沿用本檔「技師卡」範本（半寫實人物、工作場景、無文字）。
