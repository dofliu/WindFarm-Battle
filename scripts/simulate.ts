...
const mode = getArg('mode', 'versus') as 'versus' | 'weather-challenge';
...
log(`\n🎮 WindFarm Battle — 平衡驗證 (${games} 場, P1=${p1} vs P2=${p2}, seed=${seed}, mode=${mode})`);
log('─'.repeat(60));

const s = simulate({ p1, p2, games, seed, mode });
