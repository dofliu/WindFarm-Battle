...
// ---------------- evaluateTurbinePlay ----------------
export function evaluateTurbinePlay(card: Card, state: GameState, player: 0 | 1, strategy: Strategy): number {
...
// ---------------- evaluateTechPlay ----------------
export function evaluateTechPlay(card: Card, state: GameState, player: 0 | 1, strategy: Strategy): number {
  const me = state.players[player];
