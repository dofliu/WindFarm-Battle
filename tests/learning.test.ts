...
describe('extractLearningReport 整場複盤', () => {
  const events: GameEvent[] = [
    { kind: 'fault-applied', player: 0, turbineId: 'OS8', cardId: 'F04', drop: 12 },       // 遇到 blade
    { kind: 'incident', round: 2, faultCardId: 'F06', turbineId: 'OS8' },                 // 遇到 mechanical
    { kind: 'fault-repaired', player: 0, turbineId: 'OS8', cardId: 'F04', byTechCardId: 'T02', quality: 'full' },              // 完全（blade 對 blade）
    { kind: 'fault-repaired', player: 0, turbineId: 'OS8', cardId: 'F06', byTechCardId: 'T01', quality: 'partial', availLost: 9 }, // 部分（通用技師）
    { kind: 'fault-repaired', player: 1, turbineId: 'OS8', cardId: 'F04', byTechCardId: 'T02', quality: 'full' },              // 對手的修復不計入
  ];
  ...
  it('完全無故障/修復 → grade S, matchRate 1', () => {
    const r = extractLearningReport([{ kind: 'round-start', round: 1, windLabel: 'a', waveHeight: 1 }], 0);
